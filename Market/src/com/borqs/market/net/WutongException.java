 ...
 */
public class WutongException extends Exception {

	private static final long serialVersionUID = 475022994858770424L;
	private int statusCode = -1;
	
    public WutongException(String msg) {
        super(msg);
    }

    public WutongException(Exception cause) {
        super(cause);
    }

    public WutongException(String msg, int statusCode) {
        super(msg);
        this.statusCode = statusCode;
    }

    public WutongException(String msg, Exception cause) {
        super(msg, cause);
    }

    public WutongException(String msg, Exception cause, int statusCode) {
        super(msg, cause);
        this.statusCode = statusCode;
    }
	...
	public WutongException() {
		super(); 
	}

	public WutongException(String detailMessage, Throwable throwable) {
		super(detailMessage, throwable);
	}

	public WutongException(Throwable throwable) {
		super(throwable);
	}

	public WutongException(int statusCode) {
		super();
		this.statusCode = statusCode;
	}
	...
	40308 Update out of rate limit 发布微博超过上限
